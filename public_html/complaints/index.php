...
function getAllResults()
{
    ...
    if($query = mysqli_prepare($db, "SELECT * FROM reklamacje"))
    {
        ...
        while($row = mysqli_stmt_fetch($query))
        {
            ...
            echo "<td>". $date ."</td>";
            echo "<td>". $state ."</td>";
            echo "<td><a href=\"https://wypozyczalnia-rowerow-io.000webhostapp.com/complaints/details?id=" . $rid . "\">Podgląd</a></td>";
            echo "</tr>";
        }
    }
    mysqli_close($db);
                        ...
                        <table class="table table-striped table-hover" style="overflow: auto; max-height: 670px">
                            <thead style="color: white; background-color: aqua">
                                <tr>
                                    ...
                                    <th scope="col">Stan reklamacji</th>
